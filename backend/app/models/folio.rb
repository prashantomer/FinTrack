...
#
class Folio < Holding
  # Mutual-fund holding. The AMC issues a folio_number per fund×investor pair;
  # we track it per (user_instrument × platform_account) so users investing in
  # the same fund through multiple platforms see one folio per platform.
