  ...
  class ProcessTermAccountCsvJob < ApplicationJob
    ...
    def perform(import_batch_id)
      ...
      rows.each_with_index do |row, idx|
        result = Imports::ProcessTermAccountRowService.new(batch, row, idx).call
        batch.increment!(:duplicate_rows) if result == Imports::ProcessTermAccountRowService::DUPLICATE
