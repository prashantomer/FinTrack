...
const COLUMN_REFS: Record<ImportType, { col: string; req: boolean; fmt: string; ex: string }[]> = {
  investments: [
    { col: 'trade_type',      req: false, fmt: 'buy | sell (default buy)',  ex: 'buy' },
    ...
    { col: 'amount_invested', req: true,  fmt: 'decimal (proceeds for sell)', ex: '15000.00' },
    { col: 'current_value',   req: false, fmt: 'decimal (buy only)',        ex: '18500.00' },
    { col: 'purchase_date',   req: true,  fmt: 'YYYY-MM-DD or DD/MM/YYYY (sell date for sell)', ex: '2024-01-15' },
    { col: 'quantity',        req: false, fmt: 'decimal (stocks)',          ex: '10' },
    { col: 'units',           req: false, fmt: 'decimal (MF)',              ex: '100.000' },
    { col: 'price',           req: false, fmt: 'decimal — buy/sell price for stocks, NAV for MF', ex: '1500.00' },
    { col: 'order_id',        req: false, fmt: 'text — broker order reference (max 64)', ex: '240115000123456' },
    { col: 'trade_id',        req: false, fmt: 'text — broker trade/execution ID (max 64)', ex: '240115000999111' },
