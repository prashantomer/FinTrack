...
import { BarChart3, Briefcase, Building2, CreditCard, Eraser, FolderOpen, Home, LayoutDashboard, LogOut, PieChart, Settings, Sparkles, TrendingUp, Upload } from 'lucide-react'
...
const navItems = [
  ...
  { to: '/cleanup', label: 'Cleanup', icon: Eraser },
]
